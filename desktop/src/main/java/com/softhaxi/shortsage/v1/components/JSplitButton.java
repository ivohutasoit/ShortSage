...
public class JSplitButton extends AbstractButton implements Accessible {
    ...
    private static final String UI_STRING_ID = "ButtonUI";
    ...
    /**
     * Creates a new JSplitButton with initial text and icon.
     *
     * @param text the text displayed on this JSplitButton
     * @param icon the icon displayed on this JSplitButton
     */
    public JSplitButton(String text, Icon icon) {
        bMain = new JButton(text, icon);
        bPopup = new JButton(createDefaultIconPopup());

        setModel(new DefaultButtonModel());
        bMain.setBorder(BorderFactory.createEmptyBorder());
        bPopup.setBorder(BorderFactory.createEmptyBorder());
        ...
        bMain.addMouseListener(new MouseAdapter() {
            @Override
     ...
     * supplied.
     *
     * @param a action used to specify the properties of this JSplitButton
     */
     ...
     * every click
     * @see JSplitButton#isAlwaysPopup()
     */
    ...
    public Icon getDisabledSelectedPopupIcon() {
        return bPopup.getDisabledSelectedIcon();
    }
    ...
    public void setDisabledSelectedPopupIcon(Icon icon) {
        ...
        if (!oldValue.equals(icon)) {
            bPopup.setDisabledSelectedIcon(icon);
        }
    }
    ...
    public Icon getRolloverSelectedPopupIcon() {
        return bPopup.getRolloverSelectedIcon();
    }
    ...
    public void setRolloverSelectedPopupIcon(Icon icon) {
        ...
        if (!oldValue.equals(icon)) {
            bPopup.setRolloverSelectedIcon(icon);
        }
    }
    ...
    public void addActionListener(ActionListener listener) {
        bMain.addActionListener(listener);
    ...
    public void removeActionListener(ActionListener listener) {
        bMain.removeActionListener(listener);
    ...
    public void addChangeListener(ChangeListener listener) {
        bMain.addChangeListener(listener);
    ...
    public void removeChangeListener(ChangeListener listener) {
        bMain.removeChangeListener(listener);
    ...
    public void addItemListener(ItemListener listener) {
        bMain.addItemListener(listener);
    ...
    public void removeItemListener(ItemListener listener) {
        bMain.removeItemListener(listener);
    ...
    public void setComponentPopupMenu(JPopupMenu popupMenu) {
        if (popupAction != null) {
            ...
            bMain.removeActionListener(popupAction);
            bPopup.removeActionListener(popupAction);
            popupAction = null;
        }

        if (popupMenu != null) {
            popupAction = new PopupAction(popupMenu);
            bPopup.addActionListener(popupAction);

            if (alwaysShowPopup) {
                super.addActionListener(popupAction);
                bMain.addActionListener(popupAction);
            }
        }
    }
    ...
    public int getDisplayedMnemonicIndex() {
        return bMain.getDisplayedMnemonicIndex();
    }
    ...
    public void setDisplayedMnemonicIndex(int index)
        ...
        bMain.setDisplayedMnemonicIndex(index);
    ...
    public void setHideActionText(boolean hideActionText) {
        bMain.setHideActionText(hideActionText);
    ...
    /**
     * Creates default icon of pop up
     *
     * @return Icon of pop up
     */
    private Icon createDefaultIconPopup() {
        Image image = new BufferedImage(DEFAULT_POPUP_ICON_LENGTH, DEFAULT_POPUP_ICON_LENGTH,
...
//        add(Box.createRigidArea(new Dimension(splitGap, 0)));
     ...
     * @return
     */
    private Point getPopupLocationRelativeTo(Component component) {
        ...
        if (component == bPopup) {
            ...
            Insets bMainInsets = bMain.getInsets();
            int width = bMain.getWidth() + bMainInsets.left
                    + bMainInsets.right + splitGap;
            if (component == this) {
                width += insets.left;
            }
