 ...
 * @version 1.0.0
 */
public class DuplicationDetectionPage extends JPanel {
     ...
     * Main constructor
     */
    public DuplicationDetectionPage() {
        setVisible(false);
        initComponents();
        initListeners();
    }
...
//        pToolbar.add(new JButton(new ImageIcon(getClass().getClassLoader().getResource("images/ic_delete.png"))));
        ...
        ttData.getColumnModel().getColumn(1).setPreferredWidth(300);
        ttData.getColumnModel().getColumn(2).setPreferredWidth(30);
