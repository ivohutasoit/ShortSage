...
/**
 * Reference
 * <a href="http://nadeausoftware.com/articles/2008/01/java_tip_how_add_zebra_background_stripes_jtable">Zebra
 * Table</a>
 *
 * @author Ivo Hutasoit
 * @since 1
 * @version 1.0.0
 */
public class CZebraTable extends JTable {
    ...
    public CZebraTable(int numRows, int numColumns) {
        super(numRows, numColumns);
    }

    public CZebraTable(Object[][] rowData, Object[] columnNames) {
        super(rowData, columnNames);
    }

    public CZebraTable(TableModel dataModel) {
        super(dataModel);
    }

    public CZebraTable(TableModel dataModel, TableColumnModel columnModel) {
        super(dataModel, columnModel);
    }

    public CZebraTable(TableModel dataModel, TableColumnModel columnModel, ListSelectionModel selectionModel) {
        super(dataModel, columnModel, selectionModel);
    }

    public CZebraTable(Vector rowData, Vector columnNames) {
        super(rowData, columnNames);
    }
